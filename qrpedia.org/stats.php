	...
	if ( $Total_count == 0 ) {
		echo
			...
			<html lang="en">
				...
				<body>
					<h1>There are no QRpedia statistics for ' . htmlspecialchars( $path ) . '
			</body>
		</html>';
		die;
	}
...
<head>
	...
	<script type="text/javascript">
		...
		function drawDailyChart() {
			...
			<?php
				echo "chart.draw(daily_data, {width: 600, height: 300, title: 'Daily Visits to "
				. htmlspecialchars( mysql_real_escape_string( $_GET['path'] ) )
				. "'});";
			?>
		}
	...
	<style>
		#daily_div, #pie_chart_div, #daily_table_div, #destination_table_div, #bar_chart_div, #csv, h1, h2 {
			width: 800px;
			margin-left: auto;
			margin-right: auto;
		}
...
<?php
	...
	echo "<div id=\"daily_div\" ></div>";
	echo "<hr />";
	echo "<div id=\"pie_chart_div\" ></div>";
	echo "<hr />";
